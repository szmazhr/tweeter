...
function PP() {
  return (
    <div className={styles.main}>
      <h1>Privacy Policy for Tweeter</h1>

      <p>
        At Tweeter, accessible from https://szmazhr.github.io/tweeter, one of
      ...
      <p>
        ...
        shared and/or collect in Tweeter. This policy is not applicable to any
      ...
      <p>
        Tweeter follows a standard procedure of using log files. These files log
      ...
      <p>
        ...
        advertising partners of Tweeter.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Tweeter, which are sent directly
      ...
      <p>
        Note that Tweeter has no access to or control over these cookies that
      ...
      <p>
        Tweeter&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Tweeter does not knowingly collect any Personal Identifiable Information
